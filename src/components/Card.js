...
export const Card = ({ name, description, imgSource, top, key, link }) => {
  ...
  return (
    <>
      ...
      >
        <a
          href={link}
          className='max-h-96 h-96 bg-white no-underline cursor-pointer border border-[#dbdde6] flex p-10 flex-col justify-start rounded-2xl ease-in duration-200'
        >
